 ...
 */
void AdminEventCategoryBoxLayout::initUneditableWidget(SelectedWidget *uneditableWidget) {
//    QObject::connect(uneditableWidget, &SelectedWidget::signalEditCategory, this, &AdminEventCategoryBoxLayout::signalEditCategory);
//    QObject::connect(uneditableWidget, &SelectedWidget::signalDeleteCategory, this, &AdminEventCategoryBoxLayout::signalDeleteCategory);

//    QObject::connect(uneditableWidget, &SelectedWidget::signalCategorySelected, this, &AdminEventCategoryBoxLayout::signalCategorySelected);
//    QObject::connect(uneditableWidget, &SelectedWidget::signalCategoryUnselected, this, &AdminEventCategoryBoxLayout::signalCategoryUnselected);
}
...
//void AdminEventCategoryBoxLayout::addCategoryWidget(SelectedWidget *uneditableWidget, EditableEventCategoryWidget *editableWidget) {
...
void AdminEventCategoryBoxLayout::unselectUneditableWidget(SelectedWidget *uneditableWidget) {
    uneditableWidget->select();
}

void AdminEventCategoryBoxLayout::enableUneditableWidget(SelectedWidget *uneditableWidget) {
    uneditableWidget->setEnabled(true);
}

void AdminEventCategoryBoxLayout::disableUneditableWidget(SelectedWidget *uneditableWidget) {
