...
IncidentWidget::IncidentWidget(quint32 id, QString text, QString name, QWidget *parent) :  QWidget(parent), ui(new Ui::IncidentWidget) {
    ui->setupUi(this);
    this->id = id;
    this->ui->textEdit_incident_description->append(text);
    this->ui->label_incident_title->setText(name);
